...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<?php } else { ?>
      <p class="error">Please make sure config/database.php file writable. <strong>Example</strong>:<br /><br /><code>chmod 777 halogy/config/database.php</code> <br /> if this is true then double check username and password.</p>
	<?php } ?>
